...
const App = () => {
  ...
  //     price: 1999,
  //     duration: '1.5 hours',
  //     description: 'Professional groom makeup and grooming',
  //     quantity: 1,
  //     parlor: {
  //       id: '2',
  ...
  //       reviews: 1800,
  //       distance: '3.2 km',
  //       image: 'https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?auto=format&fit=crop&q=80&w=300'
  //     }
  //   },
  //   {
  //     name: 'Baby Makeup',
  //     price: 1499,
  //     duration: '1 hour',
  //     description: 'Gentle makeup suitable for children',
  //     quantity: 3,
  //     parlor: {
  //       id: '3',
  //       name: 'Kids Style Studio',
  //       rating: 4.9,
  //       reviews: 1500,
  //       distance: '1.8 km',
  //       image: 'https://images.unsplash.com/photo-1595476108010-b4d1f102b1b1?auto=format&fit=crop&q=80&w=300'
  //     }
  //   }
  // ];
                  ...
                  <div key={service.serviceId} className="border rounded-lg overflow-hidden">
                    <div
                      className={`p-4 cursor-pointer transition-all ${
                        expandedService === service.serviceName ? 'bg-blue-50' : 'hover:bg-gray-50'
                      }`}
                        ...
                        <div className="flex flex-col items-end gap-2">
                          ...
                          <ChevronDown
                            className={`w-5 h-5 transition-transform ${
                              expandedService === service.serviceName ? 'transform rotate-180' : ''
                            }`}
                          />
                        </div>
                      </div>
                      ...
                      <div className="p-4 border-t bg-blue-50">
                        <div className="space-y-4">
                          ...
                          {serviceBookings[service.serviceName]?.bookingType && 
                           serviceBookings[service.serviceName]?.bookingType !== "Today's Booking" && (
                            <div className="grid sm:grid-cols-2 gap-4">
                              <div>
