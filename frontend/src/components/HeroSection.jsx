...
const HomeContent = () => {
  ...
  return (
    <div className="bg-white overflow-hidden">
      ...
      <section className="relative h-screen flex items-center bg-gradient-to-br from-indigo-900 to-purple-800 text-white overflow-hidden">
        <div className="absolute inset-0 opacity-10 bg-[url('https://img.freepik.com/free-vector/floral-ornamental-abstract-background_52683-60025.jpg')]"></div>
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="max-w-2xl space-y-6 relative">
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-tight animate-fadeInUp bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent">
